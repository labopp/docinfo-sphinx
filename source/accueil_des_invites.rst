...
- L'invité aura-t-il besoin d'accéder aux machines du laboratoire ?
  Si oui, il lui faudra remplir un `formulaire de demande de création de compte <https://math.univ-lille1.fr/d7/sites/default/files/u107/FicheOuvertureCompte.pdf>`_ à son arrivée.
...
Pour plus de précisions, consulter la `page dédiée <http://cri.univ-lille1.fr/Documentations/reseau/wifi/>`_ à ce sujet sur le site du CRI.
